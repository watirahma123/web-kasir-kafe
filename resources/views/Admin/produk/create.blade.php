        ...
        <div class="card">
            <div class="card-body">
                ...
                @csrf
                    ...
                    <input type="file" name="gambar" class="form-control @error('gambar') is-invalid @enderror" placeholder="Gambar" value="{{ isset($produk) ? $produk->gambar : old('gambar')}}">
                    @error('gambar')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    ...
                    @isset($produk)
                        <img src="/ {{ $produk->gambar }}" width="150px" alt="">
                    @endisset
                    <br>
